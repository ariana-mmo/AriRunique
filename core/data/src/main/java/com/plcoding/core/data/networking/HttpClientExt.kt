...
//ataches all the data to the request
...
//With the lamda we pass the actual call and pass it to the safecall
//execute the call
suspend inline fun <reified T> safecall(execute: () -> HttpResponse): Result<T, DataError.Network>{
    val response = try {
        ...
        //if the user cancels then is handled it in other path
